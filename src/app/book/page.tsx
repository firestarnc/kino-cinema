      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 font-playfair text-4xl font-bold text-foreground md:text-6xl">
            Book the First-Run Cinema Screening before choosing the movie.
          </h1>
          <p className="mt-4 font-outfit text-base leading-relaxed text-muted-foreground md:text-lg">
            This is the fast path for guests who want to reserve the First-Run Cinema Screening first. Choose a package,
